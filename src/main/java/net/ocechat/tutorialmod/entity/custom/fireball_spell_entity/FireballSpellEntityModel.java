...
public class FireballSpellEntityModel extends SinglePartEntityModel<FireballSpellEntity> {
    ...
    private final ModelPart FirstDetails;
    private final ModelPart Up;
    private final ModelPart Down;
    private final ModelPart Right;
    private final ModelPart Left;
    private final ModelPart SecondDetails;
    ...
    public FireballSpellEntityModel(ModelPart root) {
        ...
        this.FirstDetails = this.Main.getChild("FirstDetails");
        this.Up = this.FirstDetails.getChild("Up");
        this.Down = this.FirstDetails.getChild("Down");
        this.Right = this.FirstDetails.getChild("Right");
        this.Left = this.FirstDetails.getChild("Left");
        this.SecondDetails = this.Main.getChild("SecondDetails");
        this.Left2 = this.SecondDetails.getChild("Left2");
        this.Right2 = this.SecondDetails.getChild("Right2");
        this.Down2 = this.SecondDetails.getChild("Down2");
        this.Up2 = this.SecondDetails.getChild("Up2");
    }
    public static TexturedModelData getTexturedModelData() {
        ModelData modelData = new ModelData();
        ModelPartData modelPartData = modelData.getRoot();
        ModelPartData Main = modelPartData.addChild("Main", ModelPartBuilder.create().uv(0, 0).cuboid(-1.3835F, -1.5647F, -1.4761F, 3.0F, 3.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 24.0F, 0.0F, -1.5708F, -1.5708F, 0.0F));

        ModelPartData FirstDetails = Main.addChild("FirstDetails", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData Up = FirstDetails.addChild("Up", ModelPartBuilder.create(), ModelTransform.pivot(-1.4F, 0.0F, -1.5F));
        ...
        ModelPartData cube_r1 = Up.addChild("cube_r1", ModelPartBuilder.create().uv(12, 0).cuboid(0.0F, -1.5F, 0.0F, 2.5F, 3.0F, 0.0F, new Dilation(0.0F))
                ...
                .uv(14, 12).cuboid(2.5F, -0.5F, 0.0F, 2.5F, 1.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(0.0165F, -0.0647F, 0.0239F, 0.0F, 0.2618F, 0.0F));

        ModelPartData Down = FirstDetails.addChild("Down", ModelPartBuilder.create(), ModelTransform.pivot(-1.3835F, -0.0647F, 1.5239F));
        ...
        ModelPartData Right = FirstDetails.addChild("Right", ModelPartBuilder.create(), ModelTransform.pivot(-1.3835F, -1.5647F, 0.0239F));
        ...
        ModelPartData Left = FirstDetails.addChild("Left", ModelPartBuilder.create(), ModelTransform.pivot(-1.3835F, 1.4353F, 0.0239F));
        ...
        ModelPartData SecondDetails = Main.addChild("SecondDetails", ModelPartBuilder.create(), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -1.5708F));
        ...
        ModelPartData Left2 = SecondDetails.addChild("Left2", ModelPartBuilder.create().uv(4, 16).cuboid(0.0F, 3.2897F, -1.5F, 0.0F, 2.2F, 0.9059F, new Dilation(0.001F))
                ...
                .uv(10, 13).cuboid(0.0F, 0.0F, -0.8941F, 0.0F, 1.7794F, 1.6F, new Dilation(0.001F)), ModelTransform.pivot(-1.5085F, -0.4397F, 0.0239F));
        ...
        ModelPartData Right2 = SecondDetails.addChild("Right2", ModelPartBuilder.create().uv(20, 0).cuboid(0.0F, 0.0F, 0.9119F, 0.0F, 0.9588F, 0.5881F, new Dilation(0.001F))
                ...
                .uv(18, 2).cuboid(0.0F, 2.9794F, 0.9119F, 0.0F, 2.0103F, 0.5881F, new Dilation(0.001F)), ModelTransform.pivot(1.4915F, -0.4397F, 0.0239F));

        ModelPartData Down2 = SecondDetails.addChild("Down2", ModelPartBuilder.create(), ModelTransform.pivot(-0.0085F, -0.4397F, 1.5239F));
        ...
        ModelPartData Up2 = SecondDetails.addChild("Up2", ModelPartBuilder.create(), ModelTransform.pivot(-0.0085F, -0.4397F, -1.4761F));
