package net.ocechat.tutorialmod.sound;
...
public class ModSound {
    ...
    public static final BlockSoundGroup MAGIC_BLOCK_SOUND_GROUP = new BlockSoundGroup(1f, 1f ,
    ...
    public static void registerSounds(){
        TutorialMod.LOGGER.info("Registering Sound for " + TutorialMod.MOD_ID);
    }
}
